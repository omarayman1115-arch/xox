...
-- ============================================================
-- حماية جدول العقارات (RLS) — للتأكيد فقط لو مش مفعّل
-- القراءة: المنشور للجميع | الكتابة: من السيرفر بعد تحقق الأدمن
-- ============================================================
