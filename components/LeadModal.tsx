...
export default function LeadModal({ property, waUrl, onClose }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-white w-full sm:max-w-md rounded-t-3xl sm:rounded-3xl overflow-hidden shadow-2xl slide-up-sheet sm:animate-none">
        ...
        <form onSubmit={submit} className="p-5 space-y-4">
          <div className="bg-slate-50 rounded-xl px-4 py-3">
            ...
            <p className="text-[#1e3a8a] font-extrabold text-sm mt-0.5">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-[#1e3a8a]/30 focus:border-[#1e3a8a] text-sm"
              autoFocus
              required
              minLength={2}
            />
          ...
          <div>
            ...
            <input
              ...
              inputMode="tel"
              dir="ltr"
              className="w-full px-4 py-3 rounded-xl border border-slate-300 focus:outline-none focus:ring-2 focus:ring-[#1e3a8a]/30 focus:border-[#1e3a8a] text-sm text-start"
              required
            />
