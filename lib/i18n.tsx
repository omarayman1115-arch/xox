...
const translations = {
  ar: {
    ...
    videoPh: "لينك تيك توك/يوتيوب/انستجرام أو رابط mp4 مباشر",
    ...
    noLeadsYet: "مفيش عملاء لسه",
    noLeadsHint: "أول ما حد يدوس \"تواصل واتساب\" في صفحة عقار هيظهر هنا",
    colClient: "العميل",
    colPhone: "رقم الموبايل",
    colProperty: "العقار",
    colDate: "التاريخ",
    colStatus: "الحالة",
    ...
    statusNotContactedShort: "لم يتم",
    whatsappTitle: "واتساب",
    deleteTitle: "حذف",
    addDetails: "أضف تفاصيل",
    detailsSaved: "التفاصيل محفوظة — دوس للتعديل",
    addClientDetails: "أضف تفاصيل العميل",
    callDetailsPh: "تفاصيل المكالمة كاملة: اتفقنا على كام؟ إمتى بيرد؟ أي ملاحظات مهمة...",
    saveDetails: "حفظ التفاصيل",
    savedCheck: "✓ اتحفظت",
    clearBtn: "مسح",
    updateFailed: "التحديث ما اتحفظش — جرب تاني",
    noteFailed: "الملاحظة ما اتحفظتش — جرب تاني",
    runNoteSql: "نفّذ supabase/leads-note.sql في SQL Editor الأول",
    followUpFailed: "موعد المتابعة ما اتحفظش — نفّذ supabase/follow-up.sql الأول",
    confirmDeleteLead: "متأكد من حذف العميل ده؟",
    searchLeadPh: "ابحث بالاسم أو رقم الموبايل…",
    searchNoResults: "مفيش عميل بالاسم أو الرقم ده",
    deleteFailed: "الحذف ما نجحش — اتأكد من النت وحاول تاني",
    published: "منشور",
    draftShort: "مسودة",
    colProperty2: "العقار",
    statusCol: "الحالة",
  ...
  en: {
    ...
    videoPh: "TikTok/YouTube/Instagram link or direct mp4 URL",
    ...
    noLeadsYet: "No clients yet",
    noLeadsHint: "As soon as someone taps \"WhatsApp\" on a property, they'll appear here",
    colClient: "Client",
    ...
    statusNotContactedShort: "Not contacted",
    whatsappTitle: "WhatsApp",
    deleteTitle: "Delete",
    addDetails: "Add details",
    detailsSaved: "Details saved — tap to edit",
    addClientDetails: "Add client details",
    callDetailsPh: "Full call details: agreed price? When will they reply? Any important notes...",
    saveDetails: "Save details",
    savedCheck: "✓ Saved",
    clearBtn: "Clear",
    updateFailed: "Update not saved — try again",
    noteFailed: "Note not saved — try again",
    runNoteSql: "Run supabase/leads-note.sql in the SQL Editor first",
    followUpFailed: "Follow-up not saved — run supabase/follow-up.sql first",
    confirmDeleteLead: "Delete this client?",
    searchLeadPh: "Search by name or phone number…",
    searchNoResults: "No client with that name or number",
    deleteFailed: "Delete failed — check your connection and try again",
    published: "Published",
    draftShort: "Draft",
    colProperty2: "Property",
    statusCol: "Status",
  },
} as const;
